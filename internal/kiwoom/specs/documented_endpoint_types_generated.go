...
// Source: internal/kiwoom/specs/documented_endpoints.json
...
type KiwoomApiDostkFrgnisttKa10009Request struct {
	StkCd string `json:"stk_cd,omitempty"`
}
...
type KiwoomApiDostkFrgnisttKa10009Response struct {
	ClosePric        string `json:"close_pric,omitempty"`
	Date             string `json:"date,omitempty"`
	FrgnrDalyNettrde string `json:"frgnr_daly_nettrde,omitempty"`
	FrgnrQotaRt      string `json:"frgnr_qota_rt,omitempty"`
	OrgnDalyNettrde  string `json:"orgn_daly_nettrde,omitempty"`
...
var documentedEndpointRequestFactories = map[string]func() any{
	...
	"/api/dostk/frgnistt|ka10009": func() any { return &KiwoomApiDostkFrgnisttKa10009Request{} },
...
var documentedEndpointResponseFactories = map[string]func() any{
	...
	"/api/dostk/frgnistt|ka10009": func() any { return &KiwoomApiDostkFrgnisttKa10009Response{} },
