...
type KISDomesticFutureoptionV1QuotationsInquireDailyFuopchartprice struct {
	...
	StckBsopDate         string `json:"-stck_bsop_date,omitempty"`
	FutsPrpr2            string `json:"-futs_prpr,omitempty"`
	FutsOprc2            string `json:"-futs_oprc,omitempty"`
	FutsHgpr2            string `json:"-futs_hgpr,omitempty"`
	FutsLwpr2            string `json:"-futs_lwpr,omitempty"`
	AcmlVol2             string `json:"-acml_vol,omitempty"`
	AcmlTrPbmn2          string `json:"-acml_tr_pbmn,omitempty"`
...
type KISDomesticFutureoptionV1TradingNgtMarginDetail struct {
	...
	Output12 DocumentedSlice[KISDomesticFutureoptionV1TradingNgtMarginDetailOutput12Item] `json:"output1,omitempty"`
	Output22 DocumentedSlice[KISDomesticFutureoptionV1TradingNgtMarginDetailOutput22Item] `json:"output2,omitempty"`
	Output32 DocumentedSlice[KISDomesticFutureoptionV1TradingNgtMarginDetailOutput32Item] `json:"output3,omitempty"`
}
...
type KISDomesticFutureoptionV1TradingNgtMarginDetailOutput12Item struct {
	FutrNewMgnAmt      string `json:"futr_new_mgn_amt,omitempty"`
	FutrSprdOrdMgna    string `json:"futr_sprd_ord_mgna,omitempty"`
	OptSllNewMgnAmt    string `json:"opt_sll_new_mgn_amt,omitempty"`
	OptBuyNewMgnAmt    string `json:"opt_buy_new_mgn_amt,omitempty"`
	NewMgnAmt          string `json:"new_mgn_amt,omitempty"`
	OptPricMgna        string `json:"opt_pric_mgna,omitempty"`
	FuopPricAltrMgna   string `json:"fuop_pric_altr_mgna,omitempty"`
	FutrSprdMgna       string `json:"futr_sprd_mgna,omitempty"`
	UwdlMgna           string `json:"uwdl_mgna,omitempty"`
	CtrtPerMinMgna     string `json:"ctrt_per_min_mgna,omitempty"`
	TotRiskMgna        string `json:"tot_risk_mgna,omitempty"`
	NetriskBrkgMgna    string `json:"netrisk_brkg_mgna,omitempty"`
	OptSllChgs         string `json:"opt_sll_chgs,omitempty"`
	OptBuyChgs         string `json:"opt_buy_chgs,omitempty"`
	FutrLossAmt        string `json:"futr_loss_amt,omitempty"`
	FutrPrftAmt        string `json:"futr_prft_amt,omitempty"`
	ThdtCcldNetLossAmt string `json:"thdt_ccld_net_loss_amt,omitempty"`
	BrkgMgna           string `json:"brkg_mgna,omitempty"`
}

type KISDomesticFutureoptionV1TradingNgtMarginDetailOutput22Item struct {
	FutrNewMgnAmt      string `json:"futr_new_mgn_amt,omitempty"`
	FutrSprdOrdMgna    string `json:"futr_sprd_ord_mgna,omitempty"`
	OptSllNewMgnAmt    string `json:"opt_sll_new_mgn_amt,omitempty"`
	OptBuyNewMgnAmt    string `json:"opt_buy_new_mgn_amt,omitempty"`
...
type KISDomesticFutureoptionV1TradingNgtMarginDetailOutput32Item struct {
	DncaCash              string `json:"dnca_cash,omitempty"`
	DncaSbst              string `json:"dnca_sbst,omitempty"`
	DncaTota              string `json:"dnca_tota,omitempty"`
	WdrwPsblCashAmt       string `json:"wdrw_psbl_cash_amt,omitempty"`
	WdrwPsblSbsa          string `json:"wdrw_psbl_sbsa,omitempty"`
	WdrwPsblTotAmt        string `json:"wdrw_psbl_tot_amt,omitempty"`
	OrdPsblCashAmt        string `json:"ord_psbl_cash_amt,omitempty"`
	OrdPsblSbsa           string `json:"ord_psbl_sbsa,omitempty"`
	OrdPsblTotAmt         string `json:"ord_psbl_tot_amt,omitempty"`
	BrkgMgnaCashAmt       string `json:"brkg_mgna_cash_amt,omitempty"`
	BrkgMgnaSbst          string `json:"brkg_mgna_sbst,omitempty"`
	BrkgMgnaTotAmt        string `json:"brkg_mgna_tot_amt,omitempty"`
	AddMgnaCashAmt        string `json:"add_mgna_cash_amt,omitempty"`
	AddMgnaSbsa           string `json:"add_mgna_sbsa,omitempty"`
	AddMgnaTotAmt         string `json:"add_mgna_tot_amt,omitempty"`
	BfdySbstSllSbstAmt    string `json:"bfdy_sbst_sll_sbst_amt,omitempty"`
	ThdtSbstSllSbstAmt    string `json:"thdt_sbst_sll_sbst_amt,omitempty"`
	BfdySbstSllCcldAmt    string `json:"bfdy_sbst_sll_ccld_amt,omitempty"`
	ThdtSbstSllCcldAmt    string `json:"thdt_sbst_sll_ccld_amt,omitempty"`
