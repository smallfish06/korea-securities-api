...
const (
	...
	defaultSpecsOutPath = "internal/kis/adapter/documented_specs.go"
	defaultTypesOutPath = "internal/kis/documented_endpoint_types_generated.go"
)
...
func generateDocumentedSpecsGo(snap *snapshot) ([]byte, error) {
	...
	b.WriteString("// documentedKISEndpointSpec defines one KIS endpoint specification from official docs.\n")
	b.WriteString("type documentedKISEndpointSpec struct {\n")
	...
	b.WriteString("var documentedKISEndpointSpecs = map[string]documentedKISEndpointSpec{\n")
