...
const (
	...
	defaultSnapshotPath = "internal/kiwoom/specs/documented_endpoints.json"
	defaultSpecsOutPath = "internal/kiwoom/specs/documented_specs_generated.go"
	defaultTypesOutPath = "internal/kiwoom/specs/documented_endpoint_types_generated.go"
)
...
func generateDocumentedSpecsGo(snap *snapshot) ([]byte, error) {
	...
	b.WriteString("// Source: internal/kiwoom/specs/documented_endpoints.json\n\n")
